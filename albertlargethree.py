...
MODEL_DIR = "albert_large_three" #@param {type:"string"}
...
CONFIG_GCS_DIR = "{}/{}/{}".format(BUCKET_PATH, "albert_large", "albert_config.json")
...
flags.DEFINE_float("learning_rate", 0.000725, "The initial learning rate.")
