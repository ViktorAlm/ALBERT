...
MODEL_DIR = "albert_base_four" #@param {type:"string"}
...
## Required parameters
flags.DEFINE_string(
    "albert_config_file", CONFIG_GCS_DIR,
    "The config json file corresponding to the pre-trained ALBERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string(
    "input_file", input_file_cmd,
    "Input TF example files (can be a glob or comma separated).")

flags.DEFINE_string(
    "output_dir", BERT_GCS_DIR,
...
flags.DEFINE_integer("train_batch_size", 1024, "Total batch size for training.")
...
flags.DEFINE_float("learning_rate", 0.00088388347, "The initial learning rate.")

flags.DEFINE_float("poly_power", 1, "The power of poly decay.")
